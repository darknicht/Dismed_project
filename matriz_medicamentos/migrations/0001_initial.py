    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pres_ref_total', models.DecimalField(decimal_places=4, max_digits=10)),
                ...
                ('prim_cuatri_mont', models.DecimalField(decimal_places=4, max_digits=10)),
                ('seg_cuatri_cant', models.IntegerField()),
                ('seg_cuatri_mont', models.DecimalField(decimal_places=4, max_digits=10)),
                ('terc_cuatri_cant', models.IntegerField()),
                ('terc_cuatri_mont', models.DecimalField(decimal_places=4, max_digits=10)),
                ...
                ('unidad_medica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unidadesmd.unidadmedica')),
            ],
            options={
